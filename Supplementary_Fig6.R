...
count <- data.frame(shCtrl_rep1=read.table("/home/zjw/zjw/20210109cornea/Scr-1_L1_339X39_Aligned.count")[,2],
                    ...
                    shFOXO3_rep1=read.table("/home/zjw/zjw/20210109cornea/V1-1_L1_336X36_Aligned.count")[,2],
                    shFOXO3_rep2=read.table("/home/zjw/zjw/20210109cornea/V1-2_L1_342X42_Aligned.count")[,2]
...
glist <- glist[names(glist) %in% et_c2$gene[et_c2$baseMean>40]]   
...
gseaplot2(gsea,geneSetID = "WP_GLYCOLYSIS_AND_GLUCONEOGENESIS",pvalue_table = F,title = "Glycolysis / Gluconeogenesis",subplots = c(1,2)) +
  gseaplot2(gsea,geneSetID = "KEGG_OXIDATIVE_PHOSPHORYLATION",pvalue_table = F,title = "Oxidative phosphorylation",subplots = c(1,2)) +
  gseaplot2(gsea,geneSetID = "GO_NEGATIVE_REGULATION_OF_GROWTH",pvalue_table = F,title = "Negative regulation of growth",subplots = c(1,2))+
  gseaplot2(gsea,geneSetID = "GO_NEGATIVE_REGULATION_OF_EPITHELIAL_CELL_MIGRATION",pvalue_table = F,title = "Negative regulation of epithelial cell migration",subplots = c(1,2)) 
